...
public class WriteWebServer extends AsyncTask<String, String, String> {
    private static final String myUserID = "6047831"; // [TODO] Fill in your ID. Your PERM number is ideal since it is a unique code that only you have access to.
    ...
    protected void onPostExecute(String result) {
        ...
        String message = "transaction is done " + CardListActivity.amount;
        Toast.makeText(callingContext.get(),message,Toast.LENGTH_SHORT).show();
    }
}
